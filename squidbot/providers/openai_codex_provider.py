...
from squidbot.providers.base import LLMProvider, LLMResponse, ToolCallRequest

DEFAULT_CODEX_URL = "https://chatgpt.com/backend-api/codex/responses"
DEFAULT_ORIGINATOR = "squidbot"
...
def _convert_tools(tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
    # Squidbot tool definitions already use the OpenAI function schema.
