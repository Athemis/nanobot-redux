...
from squidbot.agent.tools.cron import CronTool
from squidbot.agent.tools.filesystem import (
    DeleteFileTool,
    EditFileTool,
    ListDirTool,
    ReadFileTool,
...
from squidbot.agent.tools.spawn import SpawnTool
from squidbot.agent.tools.web import WebFetchTool, WebSearchTool
from squidbot.bus.events import InboundMessage, OutboundMessage
from squidbot.bus.queue import MessageBus
from squidbot.providers.base import LLMProvider
from squidbot.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from squidbot.config.schema import ExecToolConfig, WebSearchConfig
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from squidbot.agent.tools.mcp import connect_mcp_servers
