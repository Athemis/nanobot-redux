...
from squidbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("squidbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("squidbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("squidbot.cli.commands.PromptSession") as mock_prompt_session_cls, \
         patch("squidbot.cli.commands.FileHistory"), \
        ...
        _, kwargs = mock_prompt_session_cls.call_args
